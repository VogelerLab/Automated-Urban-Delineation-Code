...
year_1 = os.path.join(dir_landcoverdata, lclu_tile)
...
#fp_Developed_Reclass = os.path.join(dir_outputs, "Developed_Reclass" + country_abbrv + "_t1.tif")

Developed_Reclass = arcpy.sa.Reclassify(year_1,
                                 "Value", 
                                 Developed_Remap,
                                 "DATA"); 
...
### Project raster
fp_Developed = os.path.join(dir_outputs, "Developed_" + country_abbrv + "_t1.tif")
...
#fp_Developed_FocalStat = os.path.join(dir_outputs, "Developed_FocalStat" + country_abbrv + "_t1.tif")
...
fp_USR_Reclass = os.path.join(dir_outputs, "USR_Reclass_" + country_abbrv + "_t1.tif")
...
#fp_BU_USR_RasterCalc = os.path.join(dir_outputs, "BU_USR_" + country_abbrv + "_t1.tif")
...
### Step 10
#fp_BU_US_Reclass = os.path.join(dir_outputs, "BU_US_" + country_abbrv + "_t1.tif")
...
### Step 11
#fp_FringeOpenSpace_UC = os.path.join(dir_outputs, "FOS_UC_" + country_abbrv + "_t1.tif")
...
### Step 12
#fp_FringeOpenSpace_Reclass = os.path.join(dir_outputs, "FOS_Reclass_" + country_abbrv + "_t1.tif")
...
#fp_DefineNullforBU = os.path.join(dir_outputs, "BU_US_Null_" + country_abbrv + "_t1.tif")
...
#fp_DefineNullforFOS = os.path.join(dir_outputs, "FOS_Null_" + country_abbrv + "_t1.tif")
...
### Step 14
#fp_MergeNullOutputs = os.path.join(dir_outputs, "Merge_Null_BU_FOS_" + country_abbrv + "_t1.tif")
...
### Step 15
#Null_USFOS = os.path.join(dir_outputs, "Null_USFOS_" + country_abbrv + "_t1.tif")
...
### 17
#fp_USFOS_Reclass = os.path.join(dir_outputs, "USFOS_Reclass_" + country_abbrv + "_t1.tif")
...
fp_USFOS_Polygon = os.path.join(dir_outputs, "USFOS_Polygon_" + country_abbrv + "_t1.shp")
...
#fp_ID_COS_Polygons = os.path.join(dir_outputs, "Identify_COS_Polygons_" + country_abbrv + "_t1.shp")
...
#fp_COS_Polygons = os.path.join(dir_outputs, "COS_Polygons_" + country_abbrv + "_t1.shp")
...
COS_Polygons_Less_Than_Threshold = os.path.join(dir_outputs, "COS_Polygons_Less_Than_Threshold_" + country_abbrv + "_t1.shp")
...
#fp_fill_COS = os.path.join(dir_outputs, "Fill_COS_" + country_abbrv + "_t1.shp")
...
#fp_convert_p_to_r = os.path.join(dir_outputs, "Polygon_To_Raster_" + country_abbrv + "_t1.tif")
...
fp_urban_clusters = os.path.join(dir_outputs, "Urban_Clusters_" + country_abbrv + "_t1.shp")
...
#Urban
fp_Urban_Reclass = os.path.join(dir_outputs, "Urban_" + country_abbrv + "_t1.tif")
...
#Suburban
fp_Suburban_Reclass = os.path.join(dir_outputs, "Suburban_" + country_abbrv + "_t1.tif")
...
#Rural
fp_Rural_Reclass = os.path.join(dir_outputs, "Rural_" + country_abbrv + "_t1.tif")
...
fp_COS = os.path.join(dir_outputs, "Captured_Open_Space_" + country_abbrv + "_t1.tif")
...
fp_FOS = os.path.join(dir_outputs, "Fringe_Open_Space_" + country_abbrv + "_t1.tif")
...
arcpy.management.MosaicToNewRaster(fp_FOS + ';' + fp_COS,
                                   dir_outputs,
                                   "Urbanized_Open_Space_" + country_abbrv + "_t1.tif",
...
fp_UOS = os.path.join(dir_outputs, "Urbanized_Open_Space_" + country_abbrv + "_t1.tif")
